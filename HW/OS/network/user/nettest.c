...
// 128M by pages 4K
#define EXPECTED_FREE_PAGES ((128 << (20 - 12)) * 15 / 16)

#define FWDPORT1 2000
#define FWDPORT2 2001
#define FWDPORT3 65535
#define FWDPORT4 31231
...
int main(int argc, char *argv[]) {
  ...
  if (strcmp(argv[1], "txone") == 0) {
    ...
    if (free0 < EXPECTED_FREE_PAGES) {
      printf(
          "FAILED lazy alloc ports: too few free pages %d (expected at least "
          "%d)\n",
          free0, EXPECTED_FREE_PAGES);
    } else {
